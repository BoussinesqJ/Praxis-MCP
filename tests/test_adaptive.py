...
def ws(tmp_path):
    ...
    txs = [
        {"tx_id": f"tx-{i:03d}", "type": "buy", "ticker": "000001", "quantity": 100,
         "price": 14.0 + i * 0.5, "fee": 0, "created_at": f"2026-06-{i+1:02d}T10:00:00Z",
         "status": "confirmed", "tags": ["real"]}
        for i in range(1, 8)
    ]
    txs.extend([
        {"tx_id": "tx-sell-001", "type": "sell", "ticker": "000001", "quantity": 100,
         "price": 16.35, "fee": 0, "created_at": "2026-06-08T10:00:00Z",
         "status": "confirmed", "tags": ["real"]},
        {"tx_id": "tx-sell-002", "type": "sell", "ticker": "000001", "quantity": 100,
         "price": 15.50, "fee": 0, "created_at": "2026-06-09T10:00:00Z",
         "status": "confirmed", "tags": ["real"]},
        {"tx_id": "tx-sell-003", "type": "sell", "ticker": "000001", "quantity": 100,

...
This caused a real incident where the agent called tools with wrong IDs (`"三尺生"/"main"` instead of `"example"/"demo"`), leading to 16 wasted tool calls and incorrect performance metrics.
